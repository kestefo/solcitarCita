sap.ui.define([
	...
	return {
		...
		serviceRootpath: function () {
			var rootPath;
				rootPath = "/backendhana/IPROVIDER_ENTREGA";
				//rootPath = "https://flpnwc-zdlgl0m4e5.dispatcher.br1.hana.ondemand.com/SaasaDev";//Debugg
			return rootPath;
		},
		...
		generarHeaders: function (self, token) {
			...
			// 	})
				request.sToken = this.tagAleatorio() + this.encode("F2E7F4AE0F1E9F419EE4D59042AD4E90");
			return request;
		},
